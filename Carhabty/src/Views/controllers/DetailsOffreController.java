...
public class DetailsOffreController implements Initializable {
    ...
    @FXML
    private Label lab1, lab, labbuyer;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        CouponServices c = new CouponServices();
        int nb = c.NumberOfBuyer(CurrentOffre.Currento.getId());
        labbuyer.setText(nb + " Achteur(s)");
        labbuyer.setStyle("-fx-font: bold 15 System;-fx-text-fill: #e67e22;");
